...
export const DaftarPeminjamanBarang = () => {
    ...
    const handleExport = async () => {
        ...
        setExporting(true)
        try {
            await transactionsService.exportExcel('laporan-peminjaman-aktif.xlsx')
            setResult({
                type: "success",
                title: "Export Berhasil",
                desc: "File laporan-peminjaman-aktif.xlsx berhasil diunduh.",
            })
        } catch {
            setResult({
                type: "error",
    ...
    return (
        <div className="space-y-6">
            ...
            <ConfirmDialog
                ...
                description="Unduh semua data transaksi peminjaman aktif ke file .xlsx?"
