...
export const columns: ColumnDef<ApiTransaction>[] = [
  ...
  },
  {
    ...
    header: "No",
    cell: ({ row }) => (
      <div className="w-10 font-mono text-muted-foreground">
        {row.getValue("id")}
      </div>
    ),
  },
      ...
      return (
        <div>
          ...
          {terlambat && (
            <Badge
              variant="destructive"
              className="mt-1 gap-1 text-[10px] px-1.5 py-0"
            >
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <span
          className={
            terlambat ? "text-destructive font-medium" : "text-muted-foreground"
          }
        >
