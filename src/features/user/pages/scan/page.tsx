...
export const ScanPage = () => {
  ...
  // ── Borrow scan ───────────────────────────────────────────────────────────
  const handleBorrowScan = useCallback(
    async (code: string) => {
    ...
    <div className="flex min-h-svh flex-col bg-background px-4 py-6">
      <div className="mx-auto w-full max-w-3xl space-y-5">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="space-y-3">
            ...
            {scannedItems.length === 0 ? (
              ...
              <ScannedList
                ...
                itemLabels={Object.fromEntries(
                  scannedItems.map((i) => [i.qr_code, i.item_name]),
                )}
            ...
            {/* Notes — hanya tampil saat mode return */}
            {isReturn && (
              <div className="space-y-1.5">
                ...
                <Textarea
                  placeholder="Contoh: Barang diletakkan di..."
                  value={notes}
      ...
      {resultData && (
        <ResultDialog
          ...
          actionLabel={
            resultData.type === "success" ? "Kembali ke Beranda" : "Tutup"
          }
          onAction={() => {
